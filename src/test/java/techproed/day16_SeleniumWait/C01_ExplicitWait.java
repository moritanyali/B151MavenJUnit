 ...
 */
    ...
    public void test01() {
        ...
        //visiblityOf() methoduyla görünür olana kadar bekler.
    ...
    public void test03() {
        ...
        //Hello World! Yazının sitede oldugunu test et
        WebElement hWord = new WebDriverWait(driver, Duration.ofSeconds(20)).
                until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//h4)[2]")));
        //visiblityOf() methoduyla görünür olana kadar bekler.

        Assert.assertEquals("Hello World!", hWord.getText());
    }
