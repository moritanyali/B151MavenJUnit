...
public class C01_Cookies extends TestBase {
    ...
    public void test01() {
        ...
        Assert.assertEquals("çikolatalı", driver.manage().getCookieNamed("en sevdigim cookie").getValue());
        System.out.println(cookieSet.size());
        //System.out.println(Arrays.stream(driver.manage().getCookies().toArray()).count());
