...
public class C03_BeforeClassAfterClass {
    ...
    @BeforeClass
    public static void beforeClass() throws Exception { //Bir kez çalıştı
    ...
    @Test
    public void test02() throws InterruptedException {//yeni bir browser'da test02 methodu çalıştı. Bu methıd'dan önce before methodu olduğu için önce o çalıştı
        driver.findElement(By.cssSelector("[class='eicon-close']")).click();
        Thread.sleep(2000);
    ...
    public static void tearDown() throws Exception {//en son bir kez AfterClass methodu çalıştığı için son açılan browser kapandı.
        driver.close(); //burda her testten sonra driveri kapatır
    }
}
