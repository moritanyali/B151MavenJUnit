 ...
 */
    ...
    String dosyaYolu = "src/test/java/techproed/resources/Capitals.xlsx";
        ...
        //5 - Belirttmişiz sayfadaki satır(row) bilgisini seçmemiz gerekir.
        Row row = sheet.getRow(0); //Satır'da index 0'dan başladığı için 1. satırı getirir.
    ...
    public void test02() throws IOException {
        //PRATİK ÇÖZÜM
        //1. Satır ve 1. sütundaki bilgileri yazdıralım.
    ...
    public void test03() throws IOException {
        ...
        System.out.println(workbook.getSheet("Sheet1").getPhysicalNumberOfRows()); //11
